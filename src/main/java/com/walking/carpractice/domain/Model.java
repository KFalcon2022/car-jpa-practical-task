...
@Entity
// Подобное указание constraint'ов опционально - если не включена генерация DDL, она выполняет лишь информационную роль
@Table(uniqueConstraints = @UniqueConstraint(columnNames = {"name", "fk_brand"}))
public class Model {
    @Id
